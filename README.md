...
**Sprite Flight** is a fast-paced 2D arcade space game built with Unity.
You control a spaceship and must survive as long as possible by dodging
...
-   ✅ WebGL build playable in the browser (itch.io / portfolio)
...
This project runs on Unity (2D) with C# scripts. Below are installation
instructions for a Unity-based project.

### 💻 Installation

``` bash
# 1. Clone the repo
git clone https://github.com/nlabrazi/sprite-flight.git
cd sprite-flight

# 2. Open the project with Unity Hub
# - Add project
# - Select the folder
# - Open with the correct Unity version
...
[DotNet-url]: https://dotnet.microsoft.com/fr-fr/languages/csharp
